...
bash -c "$(curl -L https://github.com/XTLS/Xray-install/raw/main/install-release.sh) | grep tag_name | sed -E 's/.*"v(.*)".*/\1/' | head -n 1)"
...
wget -O trialtrojango "https://raw.githubusercontent.com/putrapetirr0/ARAZ/main/xray/trialtrojango.sh" && chmod +x trialtrojango
